...
<main class="main">
                        ...
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-1" src="assets/imgs/slider/donation.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-hero-slider single-animation-wrap">
                    <div class="container">
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <!-- <h4 class="animated">Great Price</h4> -->
                                    <h2 class="animated fw-900"> Great Price with </h2>
                                    <h1 class="animated fw-900 text-7"> Pre-love Item</h1>
                                    <p class="animated">Your purchase is a donation</p>
                                    <a class="animated btn btn-brush btn-brush-2" href="{{route('product')}}"> Shop Now </a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-2" src="assets/imgs/slider/purchase.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- <div class="cs-shelf__row is-marginless ">
            <div class="cs-shelf__column"> 
                <section class="c-curved-image-and-text" role="complementry">
                    <div class="c-curved-image-and-text_item lazy">
                    <img src="assets/imgs/logo/ABOUT.jpg" alt="">
                    </div> 
                <div class="c-curved-image-and-text_item">
                    <div class="c-curved-image-and-text_copy">
                        <h2>What is UTM Care Charity Shop </h2>
                        <p></p>
                        <p>
                            <span style="color: black;">
                            "UTM Care Charity Shop is a platform for communities to be part of our efforts in ‘making a difference in people’s live’. UTM in general has consistently advocated the importance and spirit of giving amongst our campus community and beyond. Empowering community through sustainable charity is a concept adopted to ensure that our beneficiaries will have seamless access to the funds and donators are provided various options to donate.
                            UTM Care Charity Shop is a retail establishment run ass a charitable entity for fund raising. It is a social enterprise that sells mainly pre-loved items such as clothes, books, and furniture donated by members of the public, and are staffed by volunteers.&nbsp;"</span>
                        </p>
                    </div>
                </div>
                </section>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-price">
                                            <span>$123.85 </span>
                                            <span class="old-price">RM{{$product->oriPrice}}</span>
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="cart.html"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
