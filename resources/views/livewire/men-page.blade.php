                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['ctg'=> $product->ctg])}}">
                                                <img class="default-img" src="{{asset('assets/imgs/shop/men/product-')}}{{$product->id}}-1.jpg" alt="{{$product->name}}">
                                                <img class="hover-img" src="{{asset('assets/imgs/shop/men/product-')}}{{$product->id}}-2.jpg" alt="{{$product->name}}">
                                            </a>
                                        </div>
