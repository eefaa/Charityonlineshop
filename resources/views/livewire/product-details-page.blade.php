                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                ...
                                                <button type="button"  class="button button-add-to-cart" onclick ="store({{$product->id}},'{{$product->name}}',{{$product->oriPrice}})" >Add to cart</button></a>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <!-- <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{asset('assets/imgs/shop/thumbnail-')}}{{$product->id}}.jpg" alt="#">
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="{{route('product.details',['ctg'=>$product->ctg])}}">{{$product->name}}</a></h5>
                                    <p class="price mb-0 mt-5">RM{{$product->oriPrice}}</p>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{route('product.details',['ctg'=>$product->ctg])}}">{{$product->name}}</a></h6>
                                    <p class="price mb-0 mt-5">RM{{$product->oriPrice}}</p>
                                    <div class="product-rate">
