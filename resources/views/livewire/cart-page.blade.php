                            ...
                            <tbody>
                                ...
                                @foreach(Cart::content() as $item) 
                                    ...
                                    <tr class="my-2">
                                        ...
                                        <td></td>
                                        <td> </td>
                                        <td class="cart_total_amount font-xl text-brand fw-900"><strong><span class="ti-gift mr-5">RM {{Cart::subtotal()}}</span></strong></td>
                                        <td></td>
                                    </tr>
                             
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="/" class="text-muted"  wire:click.prevent="clear()"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                        </td>
                                    </tr>
                            </tbody>
                        </table>
                        <div class="cart-action text-end">
                            <a href="{{route('product')}}" class="btn "><i class="fi-rs-shopping-bag mr-10"></i>Continue Shopping</a>
                        </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"> <strong><i class="ti-gift mr-5"></i>RM 5</td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label">Total</td>
                                                    <td class="cart_total_amount"><strong><span class="ti-gift mr-5">RM {{Cart::subtotal()}}</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
